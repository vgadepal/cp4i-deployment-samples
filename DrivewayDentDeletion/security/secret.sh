...
mkdir extensions
# Install mq client
wget <URL>/9.0.0.10-IBM-MQC-LinuxX64.tar.gz
tar -xvf 9.0.0.10-IBM-MQC-LinuxX64.tar.gz
./mqlicense.sh -accept
rpm -ivh MQSeriesRuntime-9.0.0-10.x86_64.rpm
rpm -ivh MQSeriesClient-9.0.0-10.x86_64.rpm
rpm -ivh MQSeriesJava-9.0.0-10.x86_64.rpm MQSeriesJRE-9.0.0-10.x86_64.rpm MQSeriesGSKit-9.0.0-10.x86_64.rpm
...
# Create extensions.zip for the ace secret
cp application.kdb application.rdb application.sth extensions/
